<section class="container d-flex align-items-center justify-content-center min-vh-100">
    <div class="card my-5 w-100">
      ...
      <div class="card-body"> 
        <form class="grid" method="post" action="index.php?page=admin_rolusuario&mode={{mode}}&UsuarioId={{UsuarioId}}&RolId={{RolId}}">
        ...
        <br/>
        <select class="width-full center" id="UsuarioId2" name="UsuarioId2" {{if readonly}}disabled{{endif readonly}}>
            {{foreach usuarios}}
        ...
        <br/>
        <select class="width-full center" id="RolId2" name="RolId2" {{if readonly}}disabled{{endif readonly}}>
            {{foreach roles}}
        ...
        <br/>
        <select class="width-full center" id="RolUsuarioEst" name="RolUsuarioEst" {{if readonly}}disabled{{endif readonly}}>
